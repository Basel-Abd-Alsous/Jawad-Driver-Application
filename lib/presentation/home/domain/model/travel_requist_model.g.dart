...
_TravelRequistModel _$TravelRequistModelFromJson(Map<String, dynamic> json) => _TravelRequistModel(
  status: json['status'] as String?,
  code: (json['code'] as num?)?.toInt(),
  message: json['message'] as String?,
  payload: (json['payload'] as List<dynamic>?)?.map((e) => TravelRequest.fromJson(e as Map<String, dynamic>)).toList(),
  isSuccess: json['isSuccess'] as bool?,
);

Map<String, dynamic> _$TravelRequistModelToJson(_TravelRequistModel instance) => <String, dynamic>{
...
_TravelRequest _$TravelRequestFromJson(Map<String, dynamic> json) => _TravelRequest(
  id: (json['id'] as num?)?.toInt(),
  rider: json['rider'] == null ? null : Rider.fromJson(json['rider'] as Map<String, dynamic>),
  ...
  arriveLat: json['arrive_lat'].toString() as String?,
  arriveLng: json['arrive_lng'].toString() as String?,
...
Map<String, dynamic> _$TravelRequestToJson(_TravelRequest instance) => <String, dynamic>{
  'id': instance.id,
...
_Service _$ServiceFromJson(Map<String, dynamic> json) => _Service(id: (json['id'] as num?)?.toInt(), name: json['name'] as String?, image: json['image'] as String?);

Map<String, dynamic> _$ServiceToJson(_Service instance) => <String, dynamic>{'id': instance.id, 'name': instance.name, 'image': instance.image};

_Status _$StatusFromJson(Map<String, dynamic> json) => _Status(name: json['name'] as String?, color: json['color'] as String?, value: json['value'] as String?);

Map<String, dynamic> _$StatusToJson(_Status instance) => <String, dynamic>{'name': instance.name, 'color': instance.color, 'value': instance.value};
