...
as String?,taxesAmount: freezed == taxesAmount ? _self.taxesAmount : taxesAmount // ignore: cast_nullable_to_non_nullable
...
class _Payload implements Payload {
  const _Payload({@JsonKey(name: "id") this.id, @JsonKey(name: "distance_between_them") this.distanceBetweenThem, @JsonKey(name: "duration_between_them") this.durationBetweenThem, @JsonKey(name: "service") this.service, @JsonKey(name: "rider") this.rider, @JsonKey(name: "chat_channel_id") this.chatChannelId, @JsonKey(name: "pickup_location") this.pickupLocation, @JsonKey(name: "arrive_location") this.arriveLocation, @JsonKey(name: "pickup_lat") this.pickupLat, @JsonKey(name: "pickup_lng") this.pickupLng, @JsonKey(name: "arrive_lat") this.arriveLat, @JsonKey(name: "arrive_lng") this.arriveLng, @JsonKey(name: "travel_no") this.travelNo, @JsonKey(name: "your_rate") this.yourRate, @JsonKey(name: "payment_status") this.paymentStatus, @JsonKey(name: "arrival_time") this.arrivalTime, @JsonKey(name: "waiting_time") this.waitingTime, @JsonKey(name: "waiting_time_fees_amount") this.waitingTimeFeesAmount, @JsonKey(name: "discount") this.discount, @JsonKey(name: "driver_profit") this.driverProfit, @JsonKey(name: "duration") this.duration, @JsonKey(name: "distance") this.distance, @JsonKey(name: "suggest_price") this.suggestPrice, @JsonKey(name: "comission") this.comission, @JsonKey(name: "amount") this.amount, @JsonKey(name: "taxes_amount") this.taxesAmount, @JsonKey(name: "started_at") this.startedAt, @JsonKey(name: "ended_at") this.endedAt, @JsonKey(name: "status") this.status, @JsonKey(name: "paid_amount") this.paidAmount, @JsonKey(name: "remaining_amount") this.remainingAmount, @JsonKey(name: 'rider_debt_paid') this.riderDebtPaid, @JsonKey(name: 'charge_client_wallet') this.chargeClientWallet});
...
@override@JsonKey(name: "taxes_amount") final  String? taxesAmount;
