...
class EditBankInfoScereen extends StatelessWidget with FormValidationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => sl<DrawerCubit>()..handelBankData(),
      child: Scaffold(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    WidgetTextField(local.enter_bank_name, controller: cubit.bankName, keyboardType: TextInputType.text, validator: (value) => cubit.stcpay.text.isNotEmpty ? null : validateNull(context, value)),
                    5.gap,
                    Text(local.iban, style: AppTextStyle.style14B.copyWith(color: AppColor.black, height: 1.2)),
                    WidgetTextField(local.enter_iban, controller: cubit.iban, maxLength: 24, keyboardType: TextInputType.text, validator: (value) => cubit.stcpay.text.isNotEmpty ? null : validateIBAN(context, value)),
                    20.gap,
                    Row(
                      spacing: 5,
                      children: [
