                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(local.plate_number, style: AppTextStyle.style16B),
                                          SizedBox(width: 250, height: 250, child: Image.asset('assets/images/2.jpeg', fit: BoxFit.contain)),
                                          TextButton(onPressed: () => Navigator.pop(context), child: Text(local.back)),
                                        ],
                                      ),
                                    ),
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(local.year, style: AppTextStyle.style14B.copyWith(color: AppColor.white, height: 1.2)),
                          isLoadingCarModelAndColor
                              ? const Padding(
                                  padding: EdgeInsets.symmetric(vertical: 10),
                                  child: WidgetLoading(width: double.infinity, radius: 2),
