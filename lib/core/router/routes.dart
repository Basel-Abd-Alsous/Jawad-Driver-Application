...
import '../../presentation/my_documents/pages/my_document_screen.dart';
import '../../presentation/myvisit/pages/my_visit_screen.dart';
...
import '../../presentation/wallet/pages/hestory_page.dart';
import '../../presentation/wallet/pages/wallet_screen.dart';
...
final GoRouter goRouter = GoRouter(
  ...
  routes: [
    ...
    ShellRoute(
      ...
      routes: [
        // Notifications
        _pageRoute(path: AppRoutes.drawalHistory, pageName: 'Drawal History Page', screen: const HestoryPage()),
        ...
        GoRoute(
          ...
          pageBuilder: (context, state) {
            ...
            final isReject = bool.tryParse(state.uri.queryParameters['isReject'] ?? 'false') ?? false;
        ...
        GoRoute(path: AppRoutes.wallet, pageBuilder: (context, state) => fadeTransitionPage('Wallet Page', const WalletScreen(), state)),
        GoRoute(path: AppRoutes.myDocuments, pageBuilder: (context, state) => fadeTransitionPage('My Documents Page', const MyDocumentScreen(), state)),
      ],
    ),
  ],
);
