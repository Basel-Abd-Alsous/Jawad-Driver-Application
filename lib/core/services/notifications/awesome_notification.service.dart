...
import 'model/notification_channel_model/notification_channel_model.dart';
import 'model/notification_payload_model/notification_payload_model.dart';
import '../../../main.dart';
...
class NotificationsController {
  ...
  static Future<void> onActionReceivedMethod(ReceivedAction receivedAction) async {
    if (receivePort != null) {
      ...
      logger.d('onActionReceivedMethod was called inside a parallel dart isolate, where receivePort was never initialized.');
      // SendPort? sendPort =
      //     IsolateNameServer.lookupPortByName('notification_action_port');

      logger.d('Redirecting the execution to main isolate process in listening...');
      ...
      if (!isAllowed) {
        ...
        await AwesomeNotifications().createNotification(
          content: NotificationContent(
            ...
            largeIcon: "asset://${Assets.imagesIconJawad}",
  ...
  static scheduleNotification({required String title, required String body, required int id, required DateTime date, Map<String, String?>? payload}) async {
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        id: id,
        title: title,
